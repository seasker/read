...
static const char __pyx_k_bbox_overlaps_gt[] = "bbox_overlaps_gt";
...
static PyObject *__pyx_n_s_bbox_overlaps_gt;
...
static PyObject *__pyx_pf_5utils_11cython_bbox_2bbox_overlaps_gt(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_boxes, PyArrayObject *__pyx_v_query_boxes); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_5utils_11cython_bbox_3bbox_overlaps_gt(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_5utils_11cython_bbox_2bbox_overlaps_gt[] = "\n    Parameters\n    ----------\n    boxes: (N, 4) ndarray of float\n    query_boxes: (K, 4) ndarray of float\n    Returns\n    -------\n    overlaps: (N, K) ndarray of overlap between boxes and query_boxes\n    ";
static PyMethodDef __pyx_mdef_5utils_11cython_bbox_3bbox_overlaps_gt = {"bbox_overlaps_gt", (PyCFunction)__pyx_pw_5utils_11cython_bbox_3bbox_overlaps_gt, METH_VARARGS|METH_KEYWORDS, __pyx_doc_5utils_11cython_bbox_2bbox_overlaps_gt};
static PyObject *__pyx_pw_5utils_11cython_bbox_3bbox_overlaps_gt(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_boxes = 0;
  PyArrayObject *__pyx_v_query_boxes = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("bbox_overlaps_gt (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_boxes,&__pyx_n_s_query_boxes,0};
    PyObject* values[2] = {0,0};
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_query_boxes)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("bbox_overlaps_gt", 1, 2, 2, 1); __PYX_ERR(0, 57, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "bbox_overlaps_gt") < 0)) __PYX_ERR(0, 57, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 2) {
      goto __pyx_L5_argtuple_error;
    } else {
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("bbox_overlaps_gt", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 57, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("utils.cython_bbox.bbox_overlaps_gt", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  ...
  __pyx_r = __pyx_pf_5utils_11cython_bbox_2bbox_overlaps_gt(__pyx_self, __pyx_v_boxes, __pyx_v_query_boxes);
...
static PyObject *__pyx_pf_5utils_11cython_bbox_2bbox_overlaps_gt(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_boxes, PyArrayObject *__pyx_v_query_boxes) {
  unsigned int __pyx_v_N;
  unsigned int __pyx_v_K;
  PyArrayObject *__pyx_v_overlaps = 0;
  __pyx_t_5utils_11cython_bbox_DTYPE_t __pyx_v_iw;
  ...
  size_t __pyx_t_40;
  size_t __pyx_t_41;
  __Pyx_RefNannySetupContext("bbox_overlaps_gt", 0);
  __pyx_pybuffer_overlaps.pybuffer.buf = NULL;
  __pyx_pybuffer_overlaps.refcount = 0;
  __pyx_pybuffernd_overlaps.data = NULL;
  __pyx_pybuffernd_overlaps.rcbuffer = &__pyx_pybuffer_overlaps;
 ...
 *                 )
 *                 if ih > 0:             # <<<<<<<<<<<<<<
 *                     overlaps[n, k] = iw * ih / float(box_area)
 *     return overlaps
 */
        __pyx_t_31 = ((__pyx_v_ih > 0.0) != 0);
        if (__pyx_t_31) {
 ...
 */
          __pyx_t_24 = (__pyx_v_iw * __pyx_v_ih);
          if (unlikely(((double)__pyx_v_box_area) == 0)) {
            PyErr_SetString(PyExc_ZeroDivisionError, "float division");
          ...
          *__Pyx_BufPtrStrided2d(__pyx_t_5utils_11cython_bbox_DTYPE_t *, __pyx_pybuffernd_overlaps.rcbuffer->pybuffer.buf, __pyx_t_40, __pyx_pybuffernd_overlaps.diminfo[0].strides, __pyx_t_41, __pyx_pybuffernd_overlaps.diminfo[1].strides) = (__pyx_t_24 / ((double)__pyx_v_box_area));
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_bbox_overlaps_gt, __pyx_k_bbox_overlaps_gt, sizeof(__pyx_k_bbox_overlaps_gt), 0, 0, 1, 1},
 ...
 */
  ...
  __pyx_codeobj__13 = (PyObject*)__Pyx_PyCode_New(2, 0, 11, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__12, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_utils_bbox_pyx, __pyx_n_s_bbox_overlaps_gt, 57, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__13)) __PYX_ERR(0, 57, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
 ...
 *         np.ndarray[DTYPE_t, ndim=2] query_boxes):
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_5utils_11cython_bbox_3bbox_overlaps_gt, NULL, __pyx_n_s_utils_cython_bbox); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 57, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_bbox_overlaps_gt, __pyx_t_2) < 0) __PYX_ERR(0, 57, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
